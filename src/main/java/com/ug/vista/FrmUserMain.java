 ...
 * @author Luis
 */
public class FrmUserMain extends javax.swing.JDialog {

    /**
     * Creates new form FrmUserMain
     */
    public FrmUserMain(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtNombreModulo.setText("Módulo Usuarios");
        sideMenuBg.add(txtNombreModulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, -1, -1));
    ...
    private void btnAgregarTxtMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_btnAgregarTxtMouseClicked
        ...
        FrmAddEditUser frm = new FrmAddEditUser(this, true, ParaAgregar);
        frm.setVisible(true);
